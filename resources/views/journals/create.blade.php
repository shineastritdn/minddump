            ...
            <div class="card shadow-sm">
                <div class="card-body p-5">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="h3 mb-0">Tulis Jurnal Baru</h1>
                    ...
                    <form action="{{ route('journals.store') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('mood') is-invalid @enderror" 
                                    ...
                                    <option value="Senang" {{ old('mood') == 'Senang' ? 'selected' : '' }}>😊 Senang</option>
                                    <option value="Sedih" {{ old('mood') == 'Sedih' ? 'selected' : '' }}>😢 Sedih</option>
                                    <option value="Marah" {{ old('mood') == 'Marah' ? 'selected' : '' }}>😠 Marah</option>
                                    <option value="Kecewa" {{ old('mood') == 'Kecewa' ? 'selected' : '' }}>😞 Kecewa</option>
                                    <option value="Bingung" {{ old('mood') == 'Bingung' ? 'selected' : '' }}>😕 Bingung</option>
                                    <option value="Tenang" {{ old('mood') == 'Tenang' ? 'selected' : '' }}>😌 Tenang</option>
                                    <option value="Semangat" {{ old('mood') == 'Semangat' ? 'selected' : '' }}>💪 Semangat</option>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" id="show_name" name="show_name" value="1" {{ old('show_name') ? 'checked' : '' }}>
